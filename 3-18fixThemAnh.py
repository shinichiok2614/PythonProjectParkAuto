...
# =====================================================
# XÁC ĐỊNH DÒNG ĐANG CHỌN (CHỈ THÊM HÀM NÀY)
# =====================================================
def get_selected():
...
# =====================================================
# ADD IMAGE (CHỈ SỬA ĐÚNG LOGIC)
# =====================================================
def add_image():
    tree, direction = get_selected()
    if tree is None:
        messagebox.showwarning("Chưa chọn", "Chọn dòng XE VÀO hoặc XE RA")
        return
...
# =====================================================
# SAVE FACE (CHỈ SỬA UPDATE THEO DÒNG CHỌN)
# =====================================================
def save_face(face):
    tree, _ = get_selected()
    if tree is None:
...
# =====================================================
# CAPTURE FACE (GIỮ NGUYÊN – CHỈ ĐÚNG LOGIC GẮN)
# =====================================================
def capture_face_window():
    if get_selected()[0] is None:
        messagebox.showwarning("Chưa chọn", "Chọn dòng cần gắn khuôn mặt")
        return
...
# =====================================================
# CAMERA + VIDEO YOLO (GIỮ NGUYÊN 100%)
# =====================================================
...
tk.Button(btn_frame,text="➕ Thêm ảnh",command=add_image).pack(fill=tk.X,pady=2)
...
def on_select(tree):
    ...
    if tree == tree_in:
        selected_label.config(text="👉 Đang chọn: 🚗 XE VÀO")
    else:
        selected_label.config(text="👉 Đang chọn: 🚙 XE RA")
